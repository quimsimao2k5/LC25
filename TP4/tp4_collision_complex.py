...
def check_ships_collision_complex():
    print("--- A iniciar Verificação BMC (Mapa Complexo) ---")
    ...
    def trans(s, s_next):
        ...
        # SEMÁFORO / SEGURANÇA (Simplificado para demonstração de colisão)
        # Se quisermos ver colisão, deixamos eles entrarem.
        # Se quisermos sistema seguro, adicionamos: And(crossing1, next_s1_id != s['s2'])
